...
Public Class Breed
    ...
    Private Sub btnDel_Click(sender As Object, e As EventArgs) Handles btnDel.Click
        ...
        Dim dogBreed As String = TextDogbreed.Text
        ...
        If result = DialogResult.Yes Then
            Try
                Call Connect_to_DB()
                Dim query As String = "DELETE FROM breed WHERE breed_id = @breed_id AND dog_breed = @dog_breed"
                Dim cmd As New MySqlCommand(query, myconn)
                cmd.Parameters.AddWithValue("@breed_id", dogID)
                cmd.Parameters.AddWithValue("@dog_breed", dogBreed)
    ...
    Private Sub DataGridView1_CellContentClick(sender As Object, e As DataGridViewCellEventArgs) Handles DataGridView1.CellContentClick
        ...
        Dim breed As String = selectedRow.Cells("dog_breed").Value.ToString()

        'Display the values in a message box
        MessageBox.Show("Selected row:" & vbCrLf & "DogID: " & id & vbCrLf & "DogBreed: " & breed)
    End Sub
