...
Public Class Sex
    ...
    Private Sub btnDel_Click(sender As Object, e As EventArgs) Handles btnDel.Click
        ...
        Dim dogSex As String = TextDogSex.Text
        ...
        If result = DialogResult.Yes Then
            Try
                Call Connect_to_DB()
                Dim query As String = "DELETE FROM sex WHERE sex_id = @sex_id AND dog_sex = @dog_sex"
                Dim cmd As New MySqlCommand(query, myconn)
                cmd.Parameters.AddWithValue("@sex_id", dogID)
                cmd.Parameters.AddWithValue("@dog_sex", dogSex)
    ...
    Private Sub DataGridView1_CellContentClick(sender As Object, e As DataGridViewCellEventArgs) Handles DataGridView1.CellContentClick
        ...
        Dim sex As String = selectedRow.Cells("dog_sex").Value.ToString()

        'Display the values in a message box
        MessageBox.Show("Selected row:" & vbCrLf & "DogID: " & id & vbCrLf & "DogSex: " & Sex)
    End Sub
